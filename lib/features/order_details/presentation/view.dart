...
import 'package:khalsha/features/order_details/presentation/bottom_sheets/add_pricing_offer.dart';
        ...
        child: Obx(() => controller.loading.value
            ...
            : controller.errorMsg.isNotEmpty
                ? Center(
                    child: Text(
                      controller.errorMsg ==
                              'ليس لديك صلاحية الدخول لهذا الرابط'
                          ? 'تم تقديم عرض سعر لهذا الطلب من مزود خدمة أخر و تم الموافقه عليه لذلك لا يمكنك رؤية تفاصيل الطلب'
                          : controller.errorMsg.tr,
                    ...
                    children: [
                      ...
                      Expanded(
                        child: PageView(
                          ...
                          children:
                              controller.pages.map((e) => e.child!).toList(),
                        ),
                      ),
                    ],
                  )),
