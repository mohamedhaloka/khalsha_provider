              ...
              () => ListView.separated(
                itemBuilder: (_, int index) => Column(
                  children: [
                    ...
                    TextFieldInputWithHolder(
                      title: 'ارقام الحاويات',
                      controller:
                          controller.invoiceItems[index].containerNumbers,
                    ...
                    TextFieldInputWithHolder(
                      ...
                      controller:
                          controller.invoiceItems[index].totalWithoutTaxs,
                      keyboardType: TextInputType.number,
                    ),
                    TextFieldInputWithHolder(
                      title: 'اجمالي ضريبة القيمة المضافة',
                      controller: controller.invoiceItems[index].totalTaxs,
                      keyboardType: TextInputType.number,
                    ),
                    TextFieldInputWithHolder(
                      title: 'نسبة ضريبة القيمة المضافة ٪',
                      controller: controller.invoiceItems[index].totalPercents,
                      keyboardType: TextInputType.number,
                    ),
