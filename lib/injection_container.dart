...
import 'package:khalsha/features/settlement_details/data/repo_impl/settlement_details_repository_impl.dart';
...
class InjectionContainer {
  ...
  static Future<void> init() async {
    ...
    sl.registerLazySingleton<GetSettlementByIdUseCase>(
        () => GetSettlementByIdUseCase(sl()));
